...
function TrustCard({ icon: Icon, title, description, delay }: TrustCardProps) {
    return (
        <motion.div
            ...
            className="group relative overflow-hidden rounded-2xl border border-border/50 bg-background/50 p-6 backdrop-blur-sm transition-all duration-300 hover:border-primary/30 hover:bg-background/80"
        >
            {/* Glow effect */}
            ...
            <div className="relative z-10">
                ...
                <h3 className="mb-2 font-space-grotesk text-lg font-semibold text-foreground">
                    {title}
                </h3>
...
export default function HomeTrust() {
    ...
    const trustCards = [
        ...
        {
            icon: Server,
            title: t('cards.onPremise.title'),
            description: t('cards.onPremise.description'),
            delay: 0.1
        },
        {
            icon: Shield,
            title: t('cards.zeroSharing.title'),
            description: t('cards.zeroSharing.description'),
            delay: 0.2
        },
        {
            icon: Cloud,
            title: t('cards.privateHosting.title'),
            description: t('cards.privateHosting.description'),
            delay: 0.3
        }
    ];
        ...
        <section className="py-16 md:py-24">
            <div className="container mx-auto px-4">
                ...
                >
                    ...
                    <h2 className="mb-4 font-space-grotesk text-3xl font-bold text-foreground md:text-4xl">
                        {t('title')}
                    </h2>
