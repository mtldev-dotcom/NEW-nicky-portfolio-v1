  ...
  const milestones = [
    {
      ...
      description: 'Started journey in graphic design and web development, establishing the creative foundation that would define my approach to technology.',
      icon: 'Palette',
      color: 'text-blue-400',
    ...
    },
    {
      ...
      location: 'Montreal, QC',
      description: 'Led digital transformation initiatives, bridging traditional design with emerging web technologies and user experience principles.',
      icon: 'Monitor',
    ...
    },
    {
      ...
      location: 'Montreal, QC',
      description: 'Deepened technical expertise in modern web frameworks, database architecture, and performance optimization strategies.',
      icon: 'Code',
    ...
    },
    {
      ...
      description: 'Expanded consulting practice across North America, specializing in digital transformation and emerging technology integration.',
      icon: 'Lightbulb',
    ...
    },
    {
      ...
      location: 'Montreal, QC',
      description: 'Founded AI automation agency, becoming an early adopter of machine learning and artificial intelligence in creative workflows.',
      icon: 'Brain',
      color: 'text-primary',
    ...
    },
    {
      ...
      location: 'Global',
      description: 'Established as The Creative Technologist, mastering the intersection of design, development, and AI to create intelligent experiences.',
      icon: 'Zap',
      color: 'text-primary',
    ...
    <div className="space-y-12">
      <div className="text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto">
          From creative foundation to AI pioneer, each milestone represents a deliberate step toward mastering the intersection of human creativity and technological innovation.
        </p>
      </div>
      <div className="relative">
        {/* Timeline Line */}
        <div className="absolute left-8 lg:left-1/2 lg:-translate-x-0.5 top-0 bottom-0 w-0.5 bg-gradient-to-b from-primary via-primary/50 to-transparent"></div>
          ...
          {milestones?.map((milestone, index) => (
            ...
            >
              ...
              <div className="absolute left-8 lg:left-1/2 lg:-translate-x-1/2 w-4 h-4 bg-background border-2 border-primary rounded-full z-10">
                <div className={`absolute inset-1 rounded-full transition-smooth ${
              ...
              <div className={`ml-20 lg:ml-0 lg:w-5/12 ${
                ...
                <div className={`bg-card/50 backdrop-blur-sm rounded-xl border border-border/50 p-6 transition-smooth hover:border-primary/30 group ${
      ...
      <div className="bg-gradient-to-br from-primary/10 to-transparent backdrop-blur-sm rounded-2xl border border-primary/20 p-8 text-center">
        ...
        <p className="text-muted-foreground max-w-lg mx-auto">
          With 20+ years of evolution from creative foundation to AI pioneer, I'm positioned to tackle the most ambitious projects at the intersection of design, technology, and artificial intelligence.
        </p>
      </div>
    </div>
  );
